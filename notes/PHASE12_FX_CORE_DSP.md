# Phase 12-2: FX 코어 13타입 DSP 식별 — 종합 매핑 문서
...
### 2.1 CM4 FX 타입 Enum (13종, 주소 0x081AF308)

CM4 펌웨어 `minifreak_main_CM4`에 있는 FX 타입 문자열 포인터 테이블. 포인터 간격 8바이트 (ARM32).

| Index | FX 타입 | CM4 주소 | 싱글턴 | 서브타입 수 |
|-------|---------|----------|--------|-----------|
| 0 | **Chorus** | 0x081AF308 | — | 5 |
| 1 | **Phaser** | 0x081AF310 | — | 6 |
| 2 | **Flanger** | 0x081AF318 | — | 4 |
| 3 | **Reverb** | 0x081AF320 | ✅ | 6 |
| 4 | **Stereo Delay** | 0x081AF328 | ✅ | 12 |
| 5 | **Distortion** | 0x081AF334 | — | 6 |
| 6 | **Bit Crusher** | 0x081AF340 | — | 0 |
| 7 | **3 Bands EQ** | 0x081AF34C | — | 3 |
| 8 | **Peak EQ** | 0x081AF354 | — | 0 |
| 9 | **Multi Comp** | 0x081AF360 | ✅ | 5 |
| 10 | **Super Unison** | 0x081AF36C | — | 8 |
| 11 | **Vocoder Self** | 0x081AF37C | — | 4 |
| 12 | **Vocoder Ext In** | — | — | 4 |
...
### 2.4 종합 매핑: CM4 13타입 → FX 코어 DSP 함수

```
┌─────────────────────────────────────────────────────────────────────┐
│              CM4 FX Enum (13 types) → FX Core DSP Mapping          │
├───────┬────────────────┬──────────────────────┬──────────┬─────────┤
...
│   4   │ Stereo Delay   │ SP1+SP2 → 0800bba0/ │ Multitap │ ★★★★★  │
│       │                │          0800bc88    │          │         │
│   5   │ Distortion     │ SP6 → FUN_0800a134  │ WaveShp  │ ★★★★☆  │
│   6   │ Bit Crusher    │ FUN_0801a468 (proc) │ BitCrush │ ★★★★☆  │
│   7   │ 3 Bands EQ     │ SP6 → FUN_08009b98  │ BiQuad   │ ★★★★★  │
│   8   │ Peak EQ        │ SP6 → FUN_08009b98  │ BiQuad   │ ★★★☆☆  │
│   9   │ Multi Comp     │ SP0 → FUN_0800b4f4  │ Envelope │ ★★★★☆  │
│  10   │ Super Unison   │ SP6 → FUN_080082f0  │ MultiDet │ ★★★☆☆  │
│  11   │ Vocoder Self   │ SP5 → FUN_0800c87c  │ Vocoder  │ ★★★★★  │
│  12   │ Vocoder Ext In │ SP4 → FUN_0800c6ac  │ Vocoder  │ ★★★★★  │
└───────┴────────────────┴──────────────────────┴──────────┴─────────┘
```
...
### 4.1 핵심 DSP 함수 (10개, DSP score ≥ 18)
